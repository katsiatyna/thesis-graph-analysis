...
def check_combined(df_0, df_1, orig_edges):
    new_edge = edges[df_1.c0]
    edges_list = list()
...
print rdd_1.collect()
schema = StructType([StructField('c' + str(i), IntegerType(), True) for i in range(1)])
...
#     df_next = df_last.join(rdd_1_df, check_combined(df_last, rdd_1_df, edges))
